/*
  # Correction finale des permissions RLS - Syntaxe corrigée

  1. Problème identifié
    - Erreur de syntaxe : "row_security" au lieu de "rowsecurity"
    - Les politiques RLS bloquent les opérations CRUD

  2. Solution
    - Correction de la syntaxe SQL
    - Politiques RLS ultra-simples et permissives
    - Diagnostic complet des permissions

  3. Sécurité
    - RLS réactivé avec politiques fonctionnelles
    - Toutes les opérations autorisées pour utilisateurs authentifiés
*/

-- =====================================================
-- 1. DIAGNOSTIC INITIAL (SYNTAXE CORRIGÉE)
-- =====================================================
...
BEGIN
  ...
  RAISE NOTICE 'RLS activé sur dishes: %', (SELECT rowsecurity FROM pg_tables WHERE tablename = 'dishes');
