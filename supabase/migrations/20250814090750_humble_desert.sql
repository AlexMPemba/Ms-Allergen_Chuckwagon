...
BEGIN
    ...
    RAISE NOTICE '   • Bouton Masquer/Afficher dans la liste des plats';
    ...
    RAISE NOTICE '   2. Cliquer "Masquer" ou "Afficher" à côté de chaque plat';
    RAISE NOTICE '   3. Ou cocher/décocher dans les formulaires d''édition';
    RAISE NOTICE '   4. Les plats masqués disparaissent du menu public';
    RAISE NOTICE '';
